    ...
    <div id="app-header">
        ...
        <div class="container-fluid relative">
            ...
            <div class="pull-right full-height visible-sm visible-xs">
                <!-- START ACTION BAR -->
                <div class="header-inner">
                    <a href="javascript:void(0);" class="btn-link visible-sm-inline-block visible-xs-inline-block"
        ...
        <div class=" pull-right">
            <div class="header-inner">
                <a href="javascript:void(0);" class="btn-link icon-set menu-hambuger-plus m-l-20 sm-no-margin hidden-sm hidden-xs" data-toggle="quickview" data-toggle-element="#quickview"></a>
            </div>
        </div>-->
        <div class=" pull-right">
            <!-- START User Info-->
            <div class="visible-lg visible-md m-t-10">
                <div class="pull-left p-r-10 p-t-10 fs-16 font-heading">
                    <span class="semi-bold text-master">userName</span>
                </div>
